...
# ------------------------------------------------------------
DATABASE_URL = "mysql+pymysql://root:Joyboy%403249@localhost:3306/todo_db"
...
if __name__ == "__main__":
    import uvicorn
    # The string below MUST match your exact file name (without .py)
    uvicorn.run("mysql_todo:app", host="127.0.0.1", port=8000, reload=True)
