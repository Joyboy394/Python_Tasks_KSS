...
# ------------------------------------------------------------
MONGO_URL = "mongodb+srv://chaitanya_db:Joyboy3249@cluster0.ukc42xe.mongodb.net/my_todo_db?appName=Cluster0"
...
if __name__ == "__main__":
    import uvicorn
    # The string below must match your exact file name (main)
